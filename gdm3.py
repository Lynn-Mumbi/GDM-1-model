...
'''This model uses data with outliers removed using imputation'''
...
gdm_imputed = impute_outliers(gdm_full, columns_with_outliers)
...
X = gdm_imputed.drop(['Class Label(GDM /Non GDM)', 'Case Number'], axis=1)
y = gdm_imputed['Class Label(GDM /Non GDM)']
