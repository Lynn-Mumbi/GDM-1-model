...
gdm_train_imputed = impute_outliers(gdm_full, columns_with_outliers)
...
print("second ")
print(gdm_train_imputed.isna().sum())
#splitting the data into feature and target variables
X = gdm_train_imputed.drop(['Class Label(GDM /Non GDM)', 'Case Number'], axis=1)
y = gdm_train_imputed['Class Label(GDM /Non GDM)']
