...
'''This model uses data with outliers removed using IQR( dropping rows)'''
...
gdm_removed_outliers = remove_outliers(gdm_full, columns_with_outliers)
print(gdm_removed_outliers.shape)
...
X = gdm_removed_outliers.drop(['Class Label(GDM /Non GDM)', 'Case Number'], axis=1)
y = gdm_removed_outliers['Class Label(GDM /Non GDM)']
